...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Evan Peterson** and I am a Junior in *Computer Science* with a minor in Data Science and Sustainability.  I was born and raised in Frankfort,          Illinois, which is a south suburb of Chicago, around 45 min. away.  Some things that I do in my free time are play chess and video games with friends.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job that has to do with data science would be artificial intelligence and machine learning.  Training a machine learning model takes a lot of training and        test data that needs to be cleaned and processed before giving to the model.  An image for this would be a captcha, which is used to gather data for machine learning.      ![captcha](https://miro.medium.com/max/844/1*Wqnhqanj3qrIn_Rdsqf8jQ.png)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: The topic I am most interested in is scraping data from websites.
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: Git version is 2.28.0.windows.1
...
10. Register a [GitHub](https://www.github.com) account. What is your username?
    ...
    Answer: My github username is Evan-Peterson.  